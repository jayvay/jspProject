	...
	<title>pdsInput.jsp</title>
 	...
 	<script>
 		...
 		function fileBoxAppend() {
			...
			fileBox += '<input type="button" value="삭제" onclick="deleteBox('+ cnt +')" class="btn btn-warning form-control mb-2 ml-2" style="width:10%" />';
			fileBox += '</div>';
	...
	<div class="container">
		<form name="myform" method="post" action="pdsInputOk.pds" enctype="multipart/form-data">
			...
			<div>
				...
				<input type="button" value="돌아가기" onclick="location.href='pdsList.pds?part=${part}';" class="btn btn-dark" />
			</div>
