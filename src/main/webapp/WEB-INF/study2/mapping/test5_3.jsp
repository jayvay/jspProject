...
<p><br/></p>
	<div class="container">
		...
		<hr/>
		<img src="${ctp}/images/14.jpg" width="400px"/>
		<hr/>
		<div>
			<input type="button" value="test5_1.jsp" onclick="location.href='${ctp}/mapping/test5.do';" class="btn btn-warning m-3" /> 
			<input type="button" value="test5_2.jsp" onclick="location.href='${ctp}/mapping/test5_2.do';" class="btn btn-warning m-3" /> 
		</div>
		<hr/>
		<pre>
