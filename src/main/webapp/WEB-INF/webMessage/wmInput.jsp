		...
		<form name="myform" method="post" action="wmInputOk.wm">
			<table class="table table-bordered">
				...
				<tr>
					<th>받는 사람</th>
					<td>
						<c:if test="${empty param.receiveId}"><input type="text" name="receiveId" placeholder="받는 사람 아이디를 입력하세요." class="form-control" /></c:if>	
				...
				<tr>
					<td colspan="2" class="text-center">
						<input type="button" value="전송" onclick="fCheck()" class="btn btn-dark mr-2" />
						<input type="reset" value="다시쓰기" class="btn btn-dark mr-2" />
						<input type="button" value="취소" onclick="history.back();" class="btn btn-dark" />
					</td>
				</tr>
			</table>
		</form>
