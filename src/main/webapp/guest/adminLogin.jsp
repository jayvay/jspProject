...
<p><br/></p>
	<div class="container">
		<form name="loginForm" method="post" action="${ctp}/guest/adminLoginOk">
			<table class="table table-bordered">
				...
				<tr>
					<th colspan="2" class="text-center">
						...
						<input type="button" value="돌아가기" onclick="location.href='${ctp}/GuestList';" class="btn-outline-warning btn" />
					</th>
				</tr>
			</table>
		</form>
