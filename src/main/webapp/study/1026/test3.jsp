...
<p><br/></p>
	<div class="container">
		...
		<%-- 
		<form name="myform" method="get" action="<%=request.getContextPath() %>/Test3OkGet">	<!-- Test3OkGet는 url mapping 경로다. -->
		<form name="myform" method="get" action="<%=request.getContextPath() %>/j1026/Test3"> 
		서블릿은 경로로 찾아가기 때문에 파일명을 앞에서 쓴 서블릿과 같은 이름으로 쓸 수 없다. 굳이 쓰고 싶으면 /j1026 상위 폴더를 써줘야 한다
		--%>
