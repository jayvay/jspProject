...
<p><br/></p>
	<div class="container">
		<form name="loginForm" method="post" action="${ctp}/database/loginOk"> <!-- jsp는 같은 위치면 경로 안 적어도 됨 -->
			<table class="table table-bordered">
				<tr>
					<th colspan="2" class="text-center"><h2>회원 로그인</h2></th>
				</tr>
				<tr>
					<th class="text-center">아이디 &nbsp;&nbsp;&nbsp; <input type="checkbox" name="idSave" checked /> 아이디 저장</th>
